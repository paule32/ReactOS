...
/* No Mouse */
#define MOUSE_TYPE_NONE            0 /* Microsoft Mouse with 2 buttons */
#define MOUSE_TYPE_MICROSOFT       1 /* Logitech  Mouse with 3 buttons */
#define MOUSE_TYPE_LOGITECH        2 /* Microsoft Wheel Mouse (aka Z Mouse) */
#define MOUSE_TYPE_WHEELZ          3 /* Mouse Systems Mouse */
...
{
    /* Setup vtbl */
    MachVtbl.ConsPutChar = NULL; // PcConsPutChar;  // paule32
    ...
    MachVtbl.VideoPutChar = NULL; // PcVideoPutChar; // paule32
