...
// hacked by paule32: 15.09.2017
extern void paule32_InitBoot(void);
VOID RunLoader(VOID)
{
#if 0
    ULONG_PTR SectionId;
    ...
    USHORT *VideoMem = (PUSHORT)0xb8000;
    unsigned Buffer  = ((0x01 << 8) | (0xb0 & 0xff));
    memset(VideoMem, Buffer, 80*25 * 2);
