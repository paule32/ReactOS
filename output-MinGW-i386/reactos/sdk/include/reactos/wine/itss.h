/*** Autogenerated by WIDL <undefined version> from /home/jens/winos/reactos/sdk/include/reactos/wine/itss.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IITStorage_QueryInterface(IITStorage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IITStorage_AddRef(IITStorage* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IITStorage_Release(IITStorage* This) {
    return This->lpVtbl->Release(This);
}
/*** IITStorage methods ***/
FORCEINLINE HRESULT IITStorage_StgCreateDocfile(IITStorage* This,const WCHAR *pwcsName,DWORD grfMode,DWORD reserved,IStorage **ppstgOpen) {
    return This->lpVtbl->StgCreateDocfile(This,pwcsName,grfMode,reserved,ppstgOpen);
}
FORCEINLINE HRESULT IITStorage_StgCreateDocfileOnILockBytes(IITStorage* This,ILockBytes *plkbyt,DWORD grfMode,DWORD reserved,IStorage **ppstgOpen) {
    return This->lpVtbl->StgCreateDocfileOnILockBytes(This,plkbyt,grfMode,reserved,ppstgOpen);
}
FORCEINLINE HRESULT IITStorage_StgIsStorageFile(IITStorage* This,const WCHAR *pwcsName) {
    return This->lpVtbl->StgIsStorageFile(This,pwcsName);
}
FORCEINLINE HRESULT IITStorage_StgIsStorageILockBytes(IITStorage* This,ILockBytes *plkbyt) {
    return This->lpVtbl->StgIsStorageILockBytes(This,plkbyt);
}
FORCEINLINE HRESULT IITStorage_StgOpenStorage(IITStorage* This,const WCHAR *pwcsName,IStorage *pstgPriority,DWORD grfMode,SNB snbExclude,DWORD reserved,IStorage **ppstgOpen) {
    return This->lpVtbl->StgOpenStorage(This,pwcsName,pstgPriority,grfMode,snbExclude,reserved,ppstgOpen);
}
FORCEINLINE HRESULT IITStorage_StgOpenStorageOnILockBytes(IITStorage* This,ILockBytes *plkbyt,IStorage *pStgPriority,DWORD grfMode,SNB snbExclude,DWORD reserved,IStorage **ppstgOpen) {
    return This->lpVtbl->StgOpenStorageOnILockBytes(This,plkbyt,pStgPriority,grfMode,snbExclude,reserved,ppstgOpen);
}
FORCEINLINE HRESULT IITStorage_StgSetTimes(IITStorage* This,const WCHAR *lpszName,const FILETIME *pctime,const FILETIME *patime,const FILETIME *pmtime) {
    return This->lpVtbl->StgSetTimes(This,lpszName,pctime,patime,pmtime);
}
FORCEINLINE HRESULT IITStorage_SetControlData(IITStorage* This,PITS_Control_Data pControlData) {
    return This->lpVtbl->SetControlData(This,pControlData);
}
FORCEINLINE HRESULT IITStorage_DefaultControlData(IITStorage* This,PITS_Control_Data *ppControlData) {
    return This->lpVtbl->DefaultControlData(This,ppControlData);
}
FORCEINLINE HRESULT IITStorage_Compact(IITStorage* This,const WCHAR *pwcsName,ECompactionLev iLev) {
