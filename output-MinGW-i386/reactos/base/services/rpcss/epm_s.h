...
typedef struct __WIDL_epm_generated_name_00000001 {
    unsigned8 int_rep;
    unsigned8 char_rep;
    unsigned8 float_rep;
    byte reserved;
} ndr_format_t;
typedef struct __WIDL_epm_generated_name_00000001 *ndr_format_p_t;
typedef struct __WIDL_epm_generated_name_00000002 {
    GUID uuid;
    unsigned16 vers_major;
    unsigned16 vers_minor;
} rpc_if_id_t;
typedef rpc_if_id_t *rpc_if_id_p_t;
typedef struct __WIDL_epm_generated_name_00000003 {
    unsigned32 count;
    rpc_if_id_p_t if_id[1];
} rpc_if_id_vector_t;
typedef rpc_if_id_vector_t *rpc_if_id_vector_p_t;
typedef struct __WIDL_epm_generated_name_00000004 {
    unsigned32 count;
    unsigned32 stats[1];
} rpc_stats_vector_t;
typedef struct __WIDL_epm_generated_name_00000004 *rpc_stats_vector_p_t;
...
typedef struct __WIDL_epm_generated_name_00000005 {
    GUID object;
    twr_t *tower;
    char annotation[64];
} ept_entry_t;
typedef struct __WIDL_epm_generated_name_00000005 *ept_entry_p_t;
