/*** Autogenerated by WIDL <undefined version> from /home/jens/winos/reactos/dll/win32/rpcrt4/epm.idl - Do not edit ***/
#include <string.h>

#include "/home/jens/winos/reactos/output-MinGW-i386/reactos/dll/win32/rpcrt4/epm_c.h"
    ...
    error_status_t *status)
{
    ...
    __params.h = h;
    __params.num_ents = num_ents;
    __params.entries = entries;
    __params.replace = replace;
    ...
    error_status_t *status)
{
    ...
    __params.status = status;
    NdrClientCall2( &epm_StubDesc,
                    &__MIDL_ProcFormatString.Format[58],
                    &__params );
}
    ...
    error_status_t *status)
{
    ...
    __params.h = h;
    __params.inquiry_type = inquiry_type;
    __params.object = object;
    __params.interface_id = interface_id;
    __params.vers_option = vers_option;
    __params.entry_handle = entry_handle;
    __params.max_ents = max_ents;
    __params.num_ents = num_ents;
    __params.entries = entries;
    __params.status = status;
    NdrClientCall2( &epm_StubDesc,
                    &__MIDL_ProcFormatString.Format[110],
                    &__params );
}
    ...
    error_status_t *status)
{
    ...
    __params.h = h;
    __params.object = object;
    __params.map_tower = map_tower;
    __params.entry_handle = entry_handle;
    __params.max_towers = max_towers;
    __params.num_towers = num_towers;
    __params.towers = towers;
    __params.status = status;
    NdrClientCall2( &epm_StubDesc,
    ...
    error_status_t *status)
{
    ...
    __params.status = status;
    NdrClientCall2( &epm_StubDesc,
                    &__MIDL_ProcFormatString.Format[274],
                    &__params );
}
    ...
    error_status_t *status)
{
    ...
    __params.h = h;
    __params.ept_object = ept_object;
    __params.status = status;
    NdrClientCall2( &epm_StubDesc,
    ...
    error_status_t *status)
{
    ...
    __params.h = h;
    __params.object_speced = object_speced;
    __params.object = object;
    __params.tower = tower;
    __params.status = status;
    NdrClientCall2( &epm_StubDesc,
