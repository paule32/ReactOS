/*** Autogenerated by WIDL <undefined version> from /home/jens/winos/reactos/dll/win32/vbscript/vbsglobal.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT GlobalObj_QueryInterface(GlobalObj* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG GlobalObj_AddRef(GlobalObj* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG GlobalObj_Release(GlobalObj* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT GlobalObj_GetTypeInfoCount(GlobalObj* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT GlobalObj_GetTypeInfo(GlobalObj* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT GlobalObj_GetIDsOfNames(GlobalObj* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT GlobalObj_Invoke(GlobalObj* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ErrObj_QueryInterface(ErrObj* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ErrObj_AddRef(ErrObj* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ErrObj_Release(ErrObj* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT ErrObj_GetTypeInfoCount(ErrObj* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT ErrObj_GetTypeInfo(ErrObj* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT ErrObj_GetIDsOfNames(ErrObj* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT ErrObj_Invoke(ErrObj* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
