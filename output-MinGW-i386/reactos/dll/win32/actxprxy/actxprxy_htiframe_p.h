...
#ifndef __actxprxy_htiframe_p_h__
#define __actxprxy_htiframe_p_h__
...
typedef enum __WIDL_actxprxy_htiframe_generated_name_00000001 {
    FINDFRAME_NONE = 0,
    FINDFRAME_JUSTTESTEXISTENCE = 1,
    FINDFRAME_INTERNAL = 0x80000000
} FINDFRAME_FLAGS;
typedef enum __WIDL_actxprxy_htiframe_generated_name_00000002 {
...
#endif /* __actxprxy_htiframe_p_h__ */
