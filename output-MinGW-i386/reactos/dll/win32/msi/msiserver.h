...
#ifdef __cplusplus
typedef class WineMsiRemotePackage WineMsiRemotePackage;
#else
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IWineMsiRemoteDatabase_QueryInterface(IWineMsiRemoteDatabase* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IWineMsiRemoteDatabase_AddRef(IWineMsiRemoteDatabase* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IWineMsiRemoteDatabase_Release(IWineMsiRemoteDatabase* This) {
    return This->lpVtbl->Release(This);
}
/*** IWineMsiRemoteDatabase methods ***/
FORCEINLINE HRESULT IWineMsiRemoteDatabase_IsTablePersistent(IWineMsiRemoteDatabase* This,LPCWSTR table,MSICONDITION *persistent) {
    return This->lpVtbl->IsTablePersistent(This,table,persistent);
}
FORCEINLINE HRESULT IWineMsiRemoteDatabase_GetPrimaryKeys(IWineMsiRemoteDatabase* This,LPCWSTR table,MSIHANDLE *keys) {
    return This->lpVtbl->GetPrimaryKeys(This,table,keys);
}
FORCEINLINE HRESULT IWineMsiRemoteDatabase_GetSummaryInformation(IWineMsiRemoteDatabase* This,UINT updatecount,MSIHANDLE *suminfo) {
    return This->lpVtbl->GetSummaryInformation(This,updatecount,suminfo);
}
FORCEINLINE HRESULT IWineMsiRemoteDatabase_OpenView(IWineMsiRemoteDatabase* This,LPCWSTR query,MSIHANDLE *view) {
    return This->lpVtbl->OpenView(This,query,view);
}
FORCEINLINE HRESULT IWineMsiRemoteDatabase_SetMsiHandle(IWineMsiRemoteDatabase* This,MSIHANDLE handle) {
    return This->lpVtbl->SetMsiHandle(This,handle);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IWineMsiRemotePackage_QueryInterface(IWineMsiRemotePackage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IWineMsiRemotePackage_AddRef(IWineMsiRemotePackage* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IWineMsiRemotePackage_Release(IWineMsiRemotePackage* This) {
    return This->lpVtbl->Release(This);
}
/*** IWineMsiRemotePackage methods ***/
FORCEINLINE HRESULT IWineMsiRemotePackage_SetMsiHandle(IWineMsiRemotePackage* This,MSIHANDLE handle) {
    return This->lpVtbl->SetMsiHandle(This,handle);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_GetActiveDatabase(IWineMsiRemotePackage* This,MSIHANDLE *handle) {
    return This->lpVtbl->GetActiveDatabase(This,handle);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_GetProperty(IWineMsiRemotePackage* This,BSTR property,BSTR value,DWORD *size) {
    return This->lpVtbl->GetProperty(This,property,value,size);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_SetProperty(IWineMsiRemotePackage* This,BSTR property,BSTR value) {
    return This->lpVtbl->SetProperty(This,property,value);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_ProcessMessage(IWineMsiRemotePackage* This,INSTALLMESSAGE message,MSIHANDLE record) {
    return This->lpVtbl->ProcessMessage(This,message,record);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_DoAction(IWineMsiRemotePackage* This,BSTR action) {
    return This->lpVtbl->DoAction(This,action);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_Sequence(IWineMsiRemotePackage* This,BSTR table,int sequence) {
    return This->lpVtbl->Sequence(This,table,sequence);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_GetTargetPath(IWineMsiRemotePackage* This,BSTR folder,BSTR value,DWORD *size) {
    return This->lpVtbl->GetTargetPath(This,folder,value,size);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_SetTargetPath(IWineMsiRemotePackage* This,BSTR folder,BSTR value) {
    return This->lpVtbl->SetTargetPath(This,folder,value);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_GetSourcePath(IWineMsiRemotePackage* This,BSTR folder,BSTR value,DWORD *size) {
    return This->lpVtbl->GetSourcePath(This,folder,value,size);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_GetMode(IWineMsiRemotePackage* This,MSIRUNMODE_T mode,BOOL *ret) {
    return This->lpVtbl->GetMode(This,mode,ret);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_SetMode(IWineMsiRemotePackage* This,MSIRUNMODE_T mode,BOOL state) {
    return This->lpVtbl->SetMode(This,mode,state);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_GetFeatureState(IWineMsiRemotePackage* This,BSTR feature,INSTALLSTATE *installed,INSTALLSTATE *action) {
    return This->lpVtbl->GetFeatureState(This,feature,installed,action);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_SetFeatureState(IWineMsiRemotePackage* This,BSTR feature,INSTALLSTATE state) {
    return This->lpVtbl->SetFeatureState(This,feature,state);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_GetComponentState(IWineMsiRemotePackage* This,BSTR component,INSTALLSTATE *installed,INSTALLSTATE *action) {
    return This->lpVtbl->GetComponentState(This,component,installed,action);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_SetComponentState(IWineMsiRemotePackage* This,BSTR component,INSTALLSTATE state) {
    return This->lpVtbl->SetComponentState(This,component,state);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_GetLanguage(IWineMsiRemotePackage* This,LANGID *language) {
    return This->lpVtbl->GetLanguage(This,language);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_SetInstallLevel(IWineMsiRemotePackage* This,int level) {
    return This->lpVtbl->SetInstallLevel(This,level);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_FormatRecord(IWineMsiRemotePackage* This,MSIHANDLE record,BSTR *value) {
    return This->lpVtbl->FormatRecord(This,record,value);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_EvaluateCondition(IWineMsiRemotePackage* This,BSTR condition) {
    return This->lpVtbl->EvaluateCondition(This,condition);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_GetFeatureCost(IWineMsiRemotePackage* This,BSTR feature,INT cost_tree,INSTALLSTATE state,INT *cost) {
    return This->lpVtbl->GetFeatureCost(This,feature,cost_tree,state,cost);
}
FORCEINLINE HRESULT IWineMsiRemotePackage_EnumComponentCosts(IWineMsiRemotePackage* This,BSTR component,DWORD index,INSTALLSTATE state,BSTR drive,DWORD *buflen,INT *cost,INT *temp) {
    return This->lpVtbl->EnumComponentCosts(This,component,index,state,drive,buflen,cost,temp);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IWineMsiRemoteCustomAction_QueryInterface(IWineMsiRemoteCustomAction* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IWineMsiRemoteCustomAction_AddRef(IWineMsiRemoteCustomAction* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IWineMsiRemoteCustomAction_Release(IWineMsiRemoteCustomAction* This) {
    return This->lpVtbl->Release(This);
}
/*** IWineMsiRemoteCustomAction methods ***/
FORCEINLINE HRESULT IWineMsiRemoteCustomAction_GetActionInfo(IWineMsiRemoteCustomAction* This,LPCGUID guid,INT *type,MSIHANDLE *handle,BSTR *dllname,BSTR *function,IWineMsiRemotePackage **package) {
    return This->lpVtbl->GetActionInfo(This,guid,type,handle,dllname,function,package);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMsiServer_QueryInterface(IMsiServer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMsiServer_AddRef(IMsiServer* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMsiServer_Release(IMsiServer* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMsiMessage_QueryInterface(IMsiMessage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMsiMessage_AddRef(IMsiMessage* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMsiMessage_Release(IMsiMessage* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMsiCustomAction_QueryInterface(IMsiCustomAction* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMsiCustomAction_AddRef(IMsiCustomAction* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMsiCustomAction_Release(IMsiCustomAction* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMsiRemoteAPI_QueryInterface(IMsiRemoteAPI* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMsiRemoteAPI_AddRef(IMsiRemoteAPI* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMsiRemoteAPI_Release(IMsiRemoteAPI* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT Installer_QueryInterface(Installer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG Installer_AddRef(Installer* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG Installer_Release(Installer* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT Installer_GetTypeInfoCount(Installer* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT Installer_GetTypeInfo(Installer* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT Installer_GetIDsOfNames(Installer* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT Installer_Invoke(Installer* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT Record_QueryInterface(Record* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG Record_AddRef(Record* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG Record_Release(Record* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT Record_GetTypeInfoCount(Record* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT Record_GetTypeInfo(Record* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT Record_GetIDsOfNames(Record* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT Record_Invoke(Record* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT StringList_QueryInterface(StringList* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG StringList_AddRef(StringList* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG StringList_Release(StringList* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT StringList_GetTypeInfoCount(StringList* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT StringList_GetTypeInfo(StringList* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT StringList_GetIDsOfNames(StringList* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT StringList_Invoke(StringList* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT RecordList_QueryInterface(RecordList* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG RecordList_AddRef(RecordList* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG RecordList_Release(RecordList* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT RecordList_GetTypeInfoCount(RecordList* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT RecordList_GetTypeInfo(RecordList* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT RecordList_GetIDsOfNames(RecordList* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT RecordList_Invoke(RecordList* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT UIPreview_QueryInterface(UIPreview* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG UIPreview_AddRef(UIPreview* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG UIPreview_Release(UIPreview* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT UIPreview_GetTypeInfoCount(UIPreview* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT UIPreview_GetTypeInfo(UIPreview* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT UIPreview_GetIDsOfNames(UIPreview* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT UIPreview_Invoke(UIPreview* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT SummaryInfo_QueryInterface(SummaryInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG SummaryInfo_AddRef(SummaryInfo* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG SummaryInfo_Release(SummaryInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT SummaryInfo_GetTypeInfoCount(SummaryInfo* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT SummaryInfo_GetTypeInfo(SummaryInfo* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT SummaryInfo_GetIDsOfNames(SummaryInfo* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT SummaryInfo_Invoke(SummaryInfo* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT View_QueryInterface(View* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG View_AddRef(View* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG View_Release(View* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT View_GetTypeInfoCount(View* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT View_GetTypeInfo(View* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT View_GetIDsOfNames(View* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT View_Invoke(View* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT Database_QueryInterface(Database* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG Database_AddRef(Database* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG Database_Release(Database* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT Database_GetTypeInfoCount(Database* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT Database_GetTypeInfo(Database* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT Database_GetIDsOfNames(Database* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT Database_Invoke(Database* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT Session_QueryInterface(Session* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG Session_AddRef(Session* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG Session_Release(Session* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT Session_GetTypeInfoCount(Session* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT Session_GetTypeInfo(Session* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT Session_GetIDsOfNames(Session* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT Session_Invoke(Session* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT FeatureInfo_QueryInterface(FeatureInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG FeatureInfo_AddRef(FeatureInfo* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG FeatureInfo_Release(FeatureInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT FeatureInfo_GetTypeInfoCount(FeatureInfo* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT FeatureInfo_GetTypeInfo(FeatureInfo* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT FeatureInfo_GetIDsOfNames(FeatureInfo* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT FeatureInfo_Invoke(FeatureInfo* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT Product_QueryInterface(Product* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG Product_AddRef(Product* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG Product_Release(Product* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT Product_GetTypeInfoCount(Product* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT Product_GetTypeInfo(Product* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT Product_GetIDsOfNames(Product* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT Product_Invoke(Product* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT Patch_QueryInterface(Patch* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG Patch_AddRef(Patch* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG Patch_Release(Patch* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT Patch_GetTypeInfoCount(Patch* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT Patch_GetTypeInfo(Patch* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT Patch_GetIDsOfNames(Patch* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT Patch_Invoke(Patch* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
