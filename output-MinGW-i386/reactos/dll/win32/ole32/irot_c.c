...
#include "/home/jens/winos/reactos/output-MinGW-i386/reactos/dll/win32/ole32/irot_c.h"
    ...
    IrotContextHandle *ctxt_handle)
{
    ...
    __params.h = h;
    __params.moniker_data = moniker_data;
    __params.object = object;
    __params.moniker = moniker;
    __params.time = time;
    __params.grfFlags = grfFlags;
    __params.cookie = cookie;
    __params.ctxt_handle = ctxt_handle;
    ...
    const MonikerComparisonData *moniker_data)
{
    ...
    __params.moniker_data = moniker_data;
    _RetVal = NdrClientCall2( &Irot_StubDesc,
                              &__MIDL_ProcFormatString.Format[146],
                              &__params );
    return (HRESULT)*(LONG_PTR *)&_RetVal;
}
    ...
    const FILETIME *time)
{
    ...
    __params.time = time;
    _RetVal = NdrClientCall2( &Irot_StubDesc,
                              &__MIDL_ProcFormatString.Format[250],
                              &__params );
    return (HRESULT)*(LONG_PTR *)&_RetVal;
}
    ...
    FILETIME *time)
{
    ...
    __params.time = time;
    _RetVal = NdrClientCall2( &Irot_StubDesc,
                              &__MIDL_ProcFormatString.Format[302],
                              &__params );
    return (HRESULT)*(LONG_PTR *)&_RetVal;
}
