...
#ifndef __ole32_oleidl_p_h__
#define __ole32_oleidl_p_h__
...
HRESULT STDMETHODCALLTYPE IDropSourceNotify_DragTargetEnter_Proxy(
    IDropSourceNotify* This,
    HWND hwnd);
void __RPC_STUB IDropSourceNotify_DragTargetEnter_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDropSourceNotify_DragTargetLeave_Proxy(
    IDropSourceNotify* This);
void __RPC_STUB IDropSourceNotify_DragTargetLeave_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
