...
#ifndef __qmgrprxy_p_h__
#define __qmgrprxy_p_h__
...
typedef enum __WIDL_qmgrprxy_generated_name_00000001 {
...
typedef enum __WIDL_qmgrprxy_generated_name_00000002 {
    BG_JOB_PRIORITY_FOREGROUND = 0,
    BG_JOB_PRIORITY_HIGH = 1,
    BG_JOB_PRIORITY_NORMAL = 2,
    BG_JOB_PRIORITY_LOW = 3
} BG_JOB_PRIORITY;
typedef enum __WIDL_qmgrprxy_generated_name_00000003 {
...
typedef enum __WIDL_qmgrprxy_generated_name_00000004 {
    BG_JOB_TYPE_DOWNLOAD = 0,
    BG_JOB_TYPE_UPLOAD = 1,
    BG_JOB_TYPE_UPLOAD_REPLY = 2
} BG_JOB_TYPE;
typedef enum __WIDL_qmgrprxy_generated_name_00000005 {
...
typedef enum __WIDL_qmgrprxy_generated_name_00000006 {
    BG_AUTH_TARGET_SERVER = 1,
    BG_AUTH_TARGET_PROXY = 2
} BG_AUTH_TARGET;
typedef enum __WIDL_qmgrprxy_generated_name_00000007 {
...
typedef struct __WIDL_qmgrprxy_generated_name_00000008 {
    LPWSTR UserName;
    LPWSTR Password;
} BG_BASIC_CREDENTIALS;
typedef BG_BASIC_CREDENTIALS *PBG_BASIC_CREDENTIALS;
typedef union __WIDL_qmgrprxy_generated_name_00000009 {
    BG_BASIC_CREDENTIALS Basic;
} BG_AUTH_CREDENTIALS_UNION;
typedef struct __WIDL_qmgrprxy_generated_name_0000000A {
